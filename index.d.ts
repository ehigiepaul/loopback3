...
declare namespace l {
      ...
      class loopback {
             ...
             * @param {any} options (optional
             */
             remoteMethod(fn: () => void, options: any): void;
      ...
      */
      ...
      class Model {
             ...
             * @param {boolean} isStatic Is the method  (eg. `MyModel.myMethod`)? Pass
      ...
      class PersistedModel extends Model {
             ...
             */
             bulkUpdate(updates: any[], options: any, callback: CallbackWithoutResult): void;
             ...
             * @param  {() => void} callback Callback function
             */
             bulkUpdate(updates: any[], options: any): Promise<void>;
             ...
             */
             changes(since: number, filter: any, callback: CallbackWithResult<any>): void;
             ...
             * @param {Array} changes An Array of [Change](#change) objects
             */
             changes(since: number, filter: any): Promise<any[]>;
             ...
             */
             count(where: any, callback: CallbackWithResult<number>): void;
             ...
             */
             create<T = any>(data: any | any[], callback: CallbackWithResult<T | T[] | null>): void;
             ...
             */
             create<T = any>(data?: any|any[]): Promise<T | T[] | null>;
             ...
             * @param  {() => void} callback
             */
             createUpdates(deltas: any[], callback: CallbackWithoutResult): void;
             ...
             * @param  {Array}    deltas
             */
             createUpdates(deltas: any[]): Promise<void>;
             ...
             */
             currentCheckpoint(callback: CallbackWithResult<number>): void;

            /**
             * Get the current checkpoint ID
             * @returns {Promise<number>} resolves to currentCheckpointId
             */
             currentCheckpoint(): Promise<number>;
             ...
             */
             destroyAll(where: any, callback: CallbackWithMultipleResults<any, number>): void;
             ...
             */
             destroyAll(where?: any): Promise<{ info: any, infoCount: number}>;
             ...
             * @param {Error} err Error object; see [Error object](docs.strongloop.com/display/LB/Error+object)
             */
             destroyById(id: any, callback: CallbackWithoutResult): void;
             ...
             */
             diff(since: number, remoteChanges: any[], callback: CallbackWithResult<any>): void;
             ...
             * @param  {Array}  remoteChanges  An Array of change objects.
             */
             diff(since: number, remoteChanges: any[]): Promise<any>;
             ...
             */
             exists(id: any, callback: CallbackWithResult<boolean>): void;
             ...
             */
             getSourceId(callback: CallbackWithResult<string>): void;
             ...
             * @param {Error} er
             */
             rectifyChange(id: any, callback: CallbackWithoutResult): void;

            /**
             * Specify that a change to the model with the given ID has occurred
             * @param {*} id The ID of the model that has changed.
             */
             rectifyChange(id: any): Promise<void>;
      ...
      class ACL extends PersistedModel {
             ...
             */
             checkAccessForContext(context: {principals: any[]; model: string|Model; id: any; property: string; accessType: string; }, callback: () => void): void;
      ...
      class Email extends Model {
             ...
             */
             send(callback: () => void, options: { from: string; to: string; subject: string; text: string; html: string; }): void;
      ...
      class KeyValueModel {
             ...
             * @param {() => void} callback
             */
             expire(key: string, ttl: number, options: any, callback: () => void): PromiseLike<any>;
             ...
             * @param {() => void} callback
             */
             get(key: string, option?: any, callback?: (err: Error, result: any) => void): PromiseLike<any>;
             ...
             */
             iterateKeys(filter: {match: string; options: any}): any;
             ...
             */
             keys(filter: {match: string; options: any}, callback: () => void): PromiseLike<any>;
             ...
             * @param {() => void} callback
             */
             set(key: string, value: any, options?: number|any, callback?: (err: Error) => void): PromiseLike<any>;
             ...
             * @param {() => void} callback
             */
             ttl(key: string, options?: any, cb?: (error: Error) => void): PromiseLike<any>;
      }
      ...
      class Role extends PersistedModel {
             ...
             */
             registerResolver(role: string, resolver: (role: string, ctx: Context, callback?: (err: Error, resolved: boolean) => void) => Promise<boolean> | void): void;
      }
      ...
      class User extends PersistedModel {
             ...
             * @param {Error} er
             */
             confirm(userId: any, token: string, redirect: string, callback?: (err: Error) => void): Promise<void> | void;
             ...
             */
             generateVerificationToken(user: any, callback?: () => void): Promise<void> | void;
             ...
             */
             login(credentials: any, include?: string[]|string, callback?: (err: Error, token: AccessToken) => void): Promise<AccessToken> | void;
             ...
             * @param {Error} er
             */
             logout(accessTokenID: string, callback?: (err: Error) => void): Promise<void> | void;
             ...
             * @param {Error} er
             */
             resetPassword(options: {}, callback?: (err: Error) => void): Promise<void> | void;
